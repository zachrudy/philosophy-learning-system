...
const ViewingStage: React.FC<ViewingStageProps> = ({
  ...
  const handleMarkAsViewed = async () => {
    try {
      ...
      // Wait a moment before navigating to the next step
      setTimeout(() => {
      ...
      <div className="mt-6 border-t border-gray-200 pt-4">
        ...
        {success && (
          <div className="mb-4 p-3 bg-green-50 border-l-4 border-green-400 text-green-700 text-sm">
            Lecture successfully marked as watched! Proceeding to reflection...
          </div>
        )}
        ...
        <button
          ...
          className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white ${
            isMarking || success ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
