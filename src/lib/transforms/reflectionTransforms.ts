// src/lib/transforms/reflectionTransforms.ts
import { Reflection } from '@prisma/client';
import { deserializeJsonFromDb, serializeJsonForDb } from '@/lib/constants';
...
/**
 * Transform a Reflection from database model to API response
 */
export function transformReflection(reflection: Reflection | null): (Reflection & {
...
/**
 * Prepare a Reflection for database storage
 */
